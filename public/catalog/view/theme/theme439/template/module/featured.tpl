							...
							<div class="right col-sm-8"><?php } else { ?><div class="right col-sm-12"><?php } ?>
								...
								<div class="inf">
									...
									<?php if ($product['price']) { ?>
									  ...
									  <?php } else { ?>
									  <span class="price-new"><?php echo $product['special']; ?></span><span class="price-old"><?php echo preg_replace("/(.00.*)$/", "", $product['price']); ?></span>
									  <?php } ?>
								...
								<div class="product_rating rating">
									<img height="18" src="catalog/view/theme/theme439/image/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $product['reviews']; ?>" />
								</div>
							</div>
						</div>
