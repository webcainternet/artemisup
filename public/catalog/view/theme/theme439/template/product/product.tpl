...
<?php echo $column_left; ?>
	...
	<div class="col-sm-8"> <?php } else { ?> <div class="col-sm-12"> <?php } ?>
	  ...
	  <div class="cart">
		<div class="prod-row">
			<div class="cart-top">
				<div class="cart-top-padd form-inline">
					...
					<a id="button-cart" class="button-prod" ><span><span><?php echo $button_cart; ?></span><i class="fa fa-shopping-cart"></i></span></a>
				</div>
		...
		<div class="review">
			<div>
				<img src="catalog/view/theme/theme439/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;
				<div class="btn-rew">
...
new AjaxUpload('#button-option-<?php echo $option['product_option_id']; ?>', {
	...
	onSubmit: function(file, extension) {
		$('#button-option-<?php echo $option['product_option_id']; ?>').after('<img src="catalog/view/theme/theme439/image/loading.gif" class="loading" style="padding-left: 5px;" />');
...
$('#button-review').bind('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#review-title').after('<div class="attention"><img src="catalog/view/theme/theme439/image/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
