          ...
          <?php foreach ($shipping_methods as $shipping_method) { ?>
            ...
            <?php if (!$shipping_method['error']) { ?>
              ...
              <tr class="highlight">
                ...
                <td style="text-align: right;"><label class="price" for="<?php echo $quote['code']; ?>"><?php echo $quote['text']; ?></label></td>
              </tr>
              <?php } ?>
            <?php } else { ?>
            <tr>
...
<?php } ?>
  ...
  <div class="checkout-product">
    <table class="table table-bordered">
      ...
      <tr>
        ...
        <td class="total price"><?php echo $total['text']; ?></td>
      </tr>
      <?php } ?>
      </tfoot>
    </table>
  ...
  <div class="buttons">
    <div class="right"><a href="<?php echo $action_confirm; ?>" class="button"><span><?php echo $button_confirm; ?></span></a></div>
  </div>
