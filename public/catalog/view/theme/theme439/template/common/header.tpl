		...
		<div class="swipe-menu">
			<ul class="links">
				...
				<?php echo $text_welcome; ?>
					<li><a href="/index.php?route=account/register"><i class="fa fa-user"></i>Criar Conta</a></li>
					<li class="login_h last"><a href="/index.php?route=account/login"><i class="fa fa-lock"></i>Entrar</a></li>
				<?php } else { ?>
					<li class="login_h last"><a href="/index.php?route=account/logout"><i class="fa fa-lock"></i>Sair</a></li>
				<?php } ?>
			</ul>			
			<?php echo $language; ?>
			<?php echo $currency; ?>
	...
	<div id="page">
		...
		<!-- Container -->
			<div id="container">
				...
				<div class="container">
					<?php if (!empty($error)) { ?>
					<div class="warning"><?php echo $error ?><img src="catalog/view/theme/theme439/image/close-1.png" alt="" class="close" /></div>
					<?php } ?>
